...
[Releases](https://github.com/vishvajeet2012/Termcode/releases). The binary embeds its
runtime, so nothing else needs to be installed.

### macOS and Linux

```sh
curl -fsSL https://raw.githubusercontent.com/vishvajeet2012/Termcode/main/install.sh | sh
```
...
```powershell
irm https://raw.githubusercontent.com/vishvajeet2012/Termcode/main/install.ps1 | iex
```
