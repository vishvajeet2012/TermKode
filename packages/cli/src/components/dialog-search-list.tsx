...
import { ScrollBoxRenderable, Text, TextAttributes, type InputRenderable } from "@opentui/core";
...
type DialogSearchListProps<T> = {
    ...
    placeholder?: string;
    emptyText?: string;
    /** Rows shown before the list scrolls. Longer lists can ask for more. */
...
export function DialogSearchList<T>({
    ...
    const visibleHeight = Math.min(filtered.length, maxVisibleItems);
